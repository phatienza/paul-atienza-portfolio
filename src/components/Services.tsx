  ...
  return (
    <section id="services" className="py-20 bg-white">
      <div className="max-w-5xl mx-auto px-5 md:px-6">
        <FadeIn>
          <h2 className="text-2xl font-bold mb-2">Freelance Work</h2>
          <p className="text-gray-500 text-sm mb-10">
            Beyond enterprise systems — websites I build for independent professionals.
          </p>
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h3 className="text-xl font-semibold mb-3 group-hover:underline underline-offset-4">
              ...
              <FiArrowUpRight className="text-gray-400 group-hover:text-black transition shrink-0 mt-1" size={20} />
            </div>
          </a>
        </FadeIn>
      </div>
